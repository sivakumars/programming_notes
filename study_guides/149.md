...
A variable can hold any kind of object, even that of a custom class. In the example below, `@pet` is set to `my_dog`, a `Dog` object. When `me.pet` is called, it returns a `Dog` object.
