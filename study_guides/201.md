...
Pseudo-classes are similar to regular classes in HTML except they are not directly written in the HTML, instead they are dynamically created as a result of a user action or the document's structure.
