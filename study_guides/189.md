...
Most data, like the content of a text message, is *unstructured*. A text message comes with additional *structured* data though. While the content of each text can vary wildly, each text has a sender's phone number, a receiver's phone number, and a date and time that the text was sent.
