...
class CMSTest < Minitest::Test
  ...
  def test_deleting_document
    ...
    post "/#{doc}/delete", {}, admin_session
    assert_equal 302, last_response.status
    assert_equal "#{doc} has been deleted.", session[:message]

    get "/"
    refute_includes last_response.body, %q(href="/#{doc})
  end
  ...
  def test_signin_with_bad_credentials
    post "/users/signin", username: "admin", password: "bummer"
    assert_equal 422, last_response.status
