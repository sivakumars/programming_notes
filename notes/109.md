...
```
 ...
 Whether Ruby acts as *pass by value* or *pass by reference* depends on the operation. Without going too deep, let's just quickly conclude and note that some call this **pass by reference of the value**.
